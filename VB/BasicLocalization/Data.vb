...
Namespace BasicLocalization
    ...
    Public Class ReceptionDeskData
        ...
        Private _MedicalAppointments As ObservableCollection(Of BasicLocalization.MedicalAppointment), _Labels As ObservableCollection(Of BasicLocalization.MedicalAppointmentType)
