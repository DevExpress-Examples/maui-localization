...
Namespace CustomLanguageResource
    ...
    Public Class ReceptionDeskData
        ...
        Private _MedicalAppointments As ObservableCollection(Of CustomLanguageResource.MedicalAppointment), _Labels As ObservableCollection(Of CustomLanguageResource.MedicalAppointmentType)
